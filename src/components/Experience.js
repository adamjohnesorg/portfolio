    ...
    <div id='experienceDiv'
      ...
      <div className='flex flex-col items-center w-10/12 sm:w-11/12'>
        <div className='flex flex-row w-full justify-center gap-8'>
          <div className='flex flex-col w-5/12 bg-white bg-opacity-10
            ...
            <div className='flex flex-col'>
              ...
              <p className='text-secondary'>
                I studied computer science and graduated in the winter.
              </p>
            </div>
          </div>
          <div className='separator flex flex-col items-center justify-evenly'>
            <div className='flex flex-col items-center justify-center w-12 h-12 
                            rounded-full bg-white border-2 border-black'>
              <img className='opacity-60 w-9/12' src={ grad_hat }></img>
            </div>
          </div>
          <div className='flex flex-col w-5/12 justify-center'>
            <div className='bg-white bg-opacity-10 border border-white
                              border-opacity-10 rounded-xl p-3 justify-center items-center
                              w-5/12'>
              <div className='flex flex-col'>
                <p className='text-secondary text-2xl'>2022</p>
              </div>
            </div>
          </div>
        </div>
        <div className='flex flex-row w-full justify-center gap-8'>
          ...
          <div className='flex flex-col w-5/12 bg-white bg-opacity-10
                          border border-white border-opacity-10 rounded-xl p-3'>
            <div className='flex flex-col'>
              <h1 className='text-primary text-3xl'>Software Coordinator</h1>
              <span className='text-secondary text-2xl'>Godfrey, IL</span>
              <p className='text-secondary'>
                I am responsible for maintaining the software systems, built multiple company 
